...
function LoginPage() {
    return (<div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100">
      <div className="text-center space-y-6 max-w-md mx-auto p-8">
        ...
        <div className="space-y-4">
          ...
          <Button asChild className="bg-teal-600 hover:bg-teal-700" data-testid="button-login">
